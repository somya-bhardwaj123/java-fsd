...
public class TryWithResources {
	public static void main(String args[]) {
		...
		try ( // Using multiple resources
				FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\OWNER\\eclipse-workspace\\Phase1\\src\\abc.txt");
				InputStream input = new FileInputStream("C:\\Users\\OWNER\\eclipse-workspace\\Phase1\\src\\abc.txt")) {
			// -----------------------------Code to write data into
			// file--------------------------------------------//
			String msg = "Welcome to Coder Somya World!";
